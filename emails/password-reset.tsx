...
export const PasswordResetEmail = ({
  ...
  <Html lang="pt-BR">
    <Head />
    <Preview>Código para redefinir sua senha: {otp}</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={content}>
          ...
          <Section style={warningBox}>
            <Text style={warningTitle}>⚠️ Não solicitou esta alteração?</Text>
          ...
          <Section style={securityBox}>
            ...
            <Text style={securityText}>
              ...
              <br />• Não reutilize senhas de outros serviços
            </Text>
          </Section>
        </Section>
